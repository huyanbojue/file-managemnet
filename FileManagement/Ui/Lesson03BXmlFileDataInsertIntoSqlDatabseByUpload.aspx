<%@ Page Language="C#" MasterPageFile="~/BootstrapMasterPage.Master" AutoEventWireup="true" CodeBehind="Lesson03BXmlFileDataInsertIntoSqlDatabseByUpload.aspx.cs" Inherits="FileManagement.Ui.Lesson03BXmlFileDataInsertIntoSqlDatabseByUpload" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <div class="" style="margin-top: 30px; font-weight: bold; color: black; font-style: normal; font-family: Verdana; text-align: center;">
                <span style="font-size: 14pt">&nbsp;&nbsp;Xml File Data Insert Into Sql Database By Upload</span>
            </div>
                ...
                <tr style="font-family: Verdana">
                    ...
                    <td align="left">&nbsp;
                       <asp:Button ID="uploadButton" Text="Upload XML" runat="server" OnClick="UploadXML" />
                        &nbsp;
                        <input type="reset" id="button_reset" name="cmdReset" onclick="return button_reset_onclick()" />&nbsp;
