...
{
    public partial class Lesson05ACsvFileReadAndBindItToGridView : System.Web.UI.Page
    {
        ...
        private void BindGrid()
        {
            ...
            using (StreamReader sr = new StreamReader(Server.MapPath("~/GeneratedFiles/ProductsFileCsv.txt")))
            {
