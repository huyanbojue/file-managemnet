<%@ Page Language="C#" MasterPageFile="~/BootstrapMasterPage.Master" AutoEventWireup="true" CodeBehind="Lesson09BTxtFileDataInsertIntoSqlDatabseByUpload.aspx.cs" Inherits="FileManagement.Lesson09BTxtFileDataInsertIntoSqlDatabseByUpload" %>
        ...
        <form id="form1" runat="server">
            <div>
                <div class="" style="margin-top: 30px; font-weight: bold; color: black; font-style: normal; font-family: Verdana; text-align: center;">
                    Txt<span style="font-size: 14pt"> File Data Insert Into Sql Database By Upload</span>
                </div>
