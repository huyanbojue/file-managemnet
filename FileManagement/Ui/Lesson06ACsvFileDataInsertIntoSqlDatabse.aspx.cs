...
{
    public partial class Lesson06ACsvFileDataInsertIntoSqlDatabse : System.Web.UI.Page
    {
        ...
        protected void insertButton_Click(object sender, EventArgs e)
        {
            ...
            table.Columns.Add();
            string line;
            using (StreamReader sr = new StreamReader(Server.MapPath("~/GeneratedFiles/CustomerFileCsv.txt")))
            {
